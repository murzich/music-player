...
export const SET_PLAY_STATUS = `${identifier}SET_PLAY_STATUS`;
export const SET_SEARCH_QUERY = `${identifier}SET_SEARCH_QUERY`;
export const SET_DURATION = `${identifier}SET_DURATION`;
export const SET_SEEKING_STATUS = `${identifier}SET_SEEKING_STATUS`;
